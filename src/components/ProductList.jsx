...
export default function ProductList({ products = [], onAddToCart, onBatchAddToCart }) {
  ...
  return (
    <div className="product-list-container animate-fade-in">
      <h2 style={{ color: '#ffffff', fontWeight: '800', fontSize: '1.8rem', marginBottom: '0.5rem', textShadow: '0 2px 8px rgba(0,0,0,0.15)' }}>상품 목록</h2>
      <p style={{ color: 'rgba(255,255,255,0.85)', marginBottom: '1.5rem', fontWeight: '500' }}>
